...
///
/// \file    runTPCQCTracksTestMod.cxx
/// \author  Stefan Heckel
///
/// \brief run TPC TracksTest QC task, reading tracks from file for the moment
///
...
//std::string filename = "tpcQCTracksTest.json";
...
std::string getConfigPath(const ConfigContext& config)
{
  ...
  std::string filename = "tpcQCTracksTestMod.json";
